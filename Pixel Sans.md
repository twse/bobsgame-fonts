...
| 0600-06FF | Arabic                                  | 57/256   |
| 0800-083F | Samaritan                               | (all)    |
| 0870-089F | Arabic Extended-B                       | 7/43     |
| 08A0-08FF | Arabic Extended-A                       | 18/96    |
| 0E00-0E7F | Thai                                    | (all)    |
...
| FB50-FDFF | Arabic Presentation Forms-A             | 16/656   |
...
### PUA Characters
The allocation of code points has been co-ordinated with characters in the [TITUS Cyberbit](http://titus.uni-frankfurt.de/), Junicode, Alphabetum, Gāndhārī Unicode, Fixedsys Excelsior, [URW Palladio HOT](http://www.sanskritweb.net/fonts/) and [Languagegeek](https://www.languagegeek.com/) fonts.
...
* F11E-F11F, F12A-F12B, F150-F151, F160-F163 – ISO 15919 diacritics (URW Palladio HOT)
...
* F800-F809 – Diacritics used in the ALA-LC transliteration scheme and Colombian native languages
* F814-F82D – Diacritics for African languages
* F870-F888 – Symbols used in Pokémon Black & White for name input (Textbook only). The .RTFN font files in the games (encoded in Unicode) redefines the Mathematical Operators, Miscellaneous Technical etc. ranges of Unicode for these symbols.
* F8FF – Apple logo
...
| 2C60-2C7F | Latin Extended-C                     | 2/32       |
...
| 4E00-9FEF | CJK Unified Ideographs               | 6372/20902 |
| A720-A7FF | Latin Extended-D                     | 2/206      |
...
| 10EC0-10EFF | Arabic Extended-C                       | 3/60     |
| 11FB0-11FBF | Lisu Supplement                         | (all)    |
| 1CC00-1CEBF | Symbols for Legacy Computing Supplement | 561/695  |
| 1CEC0-1CEFF | Miscellaneous Symbols Supplement        | (all)    |
| 1D100-1D1FF | Musical Symbols                         | 225/256  |
| 1D250-1D28F | Musical Symbols Supplement              | 30/50    |
| 1D2C0-1D2DF | Kaktovik Numerals                       | (all)    |
| 1D400-1D7FF | Mathematical Alphanumeric Symbols       | 966/997  |
| 1DC00-1DC3F | Leibnizian Ambiguous Signs              | (all)    |
| 1DF00-1DFFF | Latin Extended-G                        | (all)    |
| 1E030-1E08F | Cyrillic Extended-D                     | (all)    |
| 1F100-1F1FF | Enclosed Alphanumeric Supplement        | 180/201  |
| 1F300-1F5FF | Miscellaneous Symbols and Pictographs   | 295/768  |
| 1F600-1F64F | Emoticons                               | 31/80    |
| 1F650-1F67F | Ornamental Dingbats                     | 12/48    |
| 1F680-1F6FF | Transport and Map Symbols               | 40/120   |
| 1F700-1F77F | Alchemical Symbols                      | 8/128    |
| 1F780-1F7FF | Geometric Shapes Extended               | 85/120   |
| 1F800-1F8FF | Supplemental Arrows-C                   | 167/171  |
| 1F900-1F9FF | Supplemental Symbols and Pictographs    | 37/256   |
| 1FA00-1FA6F | Chess Symbols                           | 6/102    |
| 1FA70-1FAFF | Symbols and Pictographs Extended-A      | 21/128   |
| 1FB00-1FBFF | Symbols for Legacy Computing            | 213/250  |
...
| 1B000-1B0FF | Kana Supplement                         | 68/256   |
| 1B100-1B12F | Kana Extended-A                         | 17/41    |
| 1B130-1B16F | Small Kana Extension                    | (all)    |
| 1F100-1F1FF | Enclosed Alphanumeric Supplement        | 180/200  |
| 1F200-1F2FF | Enclosed Ideographic Supplement         | 21/64    |
...
Use PS3Xploit's Flash Font Replacer or Rebug Toolbox with FileZilla to change the font. **Pixel Sans** (or Terminal/Textbook) is `SCE-PS3-RD-R-LATIN(2).TTF` and **Pixel Sans Fallback** is `SCE-PS3-NR-R-JPN.TTF` (Japanese) or `SCE-PS3-YG-R-KOR.TTF` (Korean).

> [!NOTE]
> The console stores its fonts in `data/font` or `dev_rebug/data/font` (FileZilla, if Rebug Toolbox is installed) and can be changed in **Settings: Theme Settings: Font** (the system software language must not be Chinese or Korean). On version ≤ 4.81, non-hybrid firmwares or non-PlayStation 3 browsers (e.g. Firefox Desktop or WebPositive), PS3Xploit disables all features.

### Font Linking (Windows and Wine)
Use Registry Editor (Windows 10 and 11 adds the program as a shortcut in the **Windows Administrative Tools** program group) to add **Pixel Sans**, **Pixel Sans Terminal** and **Pixel Sans Textbook** to `HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows NT\CurrentVersion\FontLink\SystemLink` with the value `Pixel Sans Fallback.ttf,Pixel Sans Fallback` and restart.
...
4. Select Pixel Sans Fallback as the default sans-serif font for Japanese and Korean (for most browsers like Internet Explorer).
...
* Chu Chu Rocket! – This font is used in the dialogue.
* Daisenryaku
* DiGi Charat: DigiCommunication
* Dokodemo Taikyoku Yakuman Advance
* Domokun no Fushigi Telebi
* Flame of Recca
* Gadget Racers
...
* Gunstar Super Heroes – The font is used in the dialogue.
* Hamster Story 2
...
* Monster Guardians
* Muscular Ranking
* Rhythm Tengoku – The font is used in the right side of the credits.
* Robot Ponkotto 2
* Sansara Saga 1×2
* Shanghai Advance
...
* Shin Megami Tensei: Devil Summoners: Soul Hackers – Used in parts of the UI, e.g. during battles.
...
* Element Hunters – The NFTR files are encoded in Unicode, though many Shift-JIS characters not normally needed in-game are omitted.
* Emblem of Gundam
...
* L.O.L.
* Lost in Blue II – The font is available in-game as **font0**, **font1** or **font_01**–**font_04** in NANR, NCER or NCGR.
* Love Plus series
...
* More English Training – The font is available in-game as **European_LC12.NFTR** (European – encoded as Unicode) and **LC12.NFTR** (Japanese – encoded as Shift-JIS) in `common/fonts/data`. The NFTR in the Japanese version omits many non-essential ASCII and Shift-JIS characters.
* Mumin no Okurimono
* MySims
...
* Pokémon Black & White (also used in beta release and its sequel) – The font is available in-game as **a/0/2/3/3_0.RTFN** (encoded as Unicode). All Greek and many Cyrillic characters are omitted.
...
* Super Robot Wars OG Saga: Mugen no Frontier EXCEED
* Tactical Guild
